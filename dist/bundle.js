...
/***/ function(module, exports, __webpack_require__) {
	...
	var switcher = function switcher(hash) {
	  ...
	  switch (hashArray[0]) {
	    ...
	    case 'wiki':
	      page = 'wiki';
	      render(_componentsPost2['default'], hashArray[1]);
	      break;
	    case 'blog':
	      page = 'blog';
	      render(_componentsPost2['default'], hashArray[1]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getListData = function getListData(type, render) {
	  ...
	  _function2['default'].get('dist/' + type + '.json', function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = __webpack_require__(44);
	...
	var getPostList = function getPostList(render) {
	  _function2['default'].get(query.url, function (list) {
