  ...
  * Hook 在 v16.8 正式发布了
    ...
    * 功能
      * useEffect
        ...
        * async
          * [Unlike componentDidMount or componentDidUpdate, effects scheduled with useEffect don’t block the browser from updating the screen](https://reactjs.org/docs/hooks-effect.html#detailed-explanation)
          * [fires after layout and paint, during a deferred event](https://reactjs.org/docs/hooks-reference.html#timing-of-effects)
